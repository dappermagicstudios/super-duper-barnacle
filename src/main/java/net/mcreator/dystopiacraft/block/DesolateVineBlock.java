...
public class DesolateVineBlock extends DystopiacraftModElements.ModElement {
	@ObjectHolder("dystopiacraft:desolate_vine")
	public static final Block block = null;
	public DesolateVineBlock(DystopiacraftModElements instance) {
		super(instance, 25);
	}
