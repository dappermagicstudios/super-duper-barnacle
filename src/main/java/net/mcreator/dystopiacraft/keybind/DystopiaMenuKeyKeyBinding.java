...
package net.mcreator.dystopiacraft.keybind;
...
public class DystopiaMenuKeyKeyBinding extends DystopiacraftModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public DystopiaMenuKeyKeyBinding(DystopiacraftModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		keys = new KeyBinding("key.dystopiacraft.dystopia_menu_key", GLFW.GLFW_KEY_R, "key.categories.ui");
