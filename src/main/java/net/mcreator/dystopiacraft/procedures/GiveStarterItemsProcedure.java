...
import net.mcreator.dystopiacraft.item.FolderItem;
...
public class GiveStarterItemsProcedure extends DystopiacraftModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity.getCapability(DystopiacraftModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new DystopiacraftModVariables.PlayerVariables())).PlayerClass) == 2)) {
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(FolderItem.block, (int) (1));
				_setstack.setCount((int) 1);
				ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) entity), _setstack);
			}
		}
