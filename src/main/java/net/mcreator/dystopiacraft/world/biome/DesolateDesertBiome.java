...
public class DesolateDesertBiome extends DystopiacraftModElements.ModElement {
	public static Biome biome;
	public DesolateDesertBiome(DystopiacraftModElements instance) {
		super(instance, 3);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("dystopiacraft:desolate_desert"));
			}
		}
	}
	@Override
