...
import net.mcreator.dystopiacraft.block.DesolateVineBlock;
import net.mcreator.dystopiacraft.block.DecayingLogBlock;
import net.mcreator.dystopiacraft.block.DecayingLeavesBlock;
...
public class DesolateforestBiome extends DystopiacraftModElements.ModElement {
	public static Biome biome;
	public DesolateforestBiome(DystopiacraftModElements instance) {
		super(instance, 8);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(DecayingLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(DecayingLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("dystopiacraft:desolateforest"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("desolateforest_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, DesolateVineBlock.block.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("desolateforest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("desolateforest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
